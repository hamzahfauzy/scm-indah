<section class="content">
    <div class="container-fluid">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Tambah Data Persediaan Ayam</h1>
        ...
        <form action="" method="post" class="col-12 col-md-6">
            <div class="mb-3">
                ...
                <input type="date" class="form-control" name="ayam[tanggal]" required>
            </div>
            <div class="mb-3">
                <label for="">Nomor Kandang</label>
                <input type="text" class="form-control" name="ayam[no_kandang]" required>
            </div>
            <div class="mb-3">
